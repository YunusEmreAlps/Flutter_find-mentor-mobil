...
class _JobsPageBodyState extends State<JobsPageBody> {
  ...
  SingleChildScrollView jobListContainer() {
  ...
  Padding jobSearchBox(BuildContext context) {
    return Padding(
      ...
      child: Material(
        ...
        child: AppWidget.getSearchBox(
            isKeyboardVisible, context, AppStrings.SEARCH_JOB),
      ),
    );
  }
}
