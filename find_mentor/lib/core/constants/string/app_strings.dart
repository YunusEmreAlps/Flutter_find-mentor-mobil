...
class AppStrings {
  ...
  static final String ARE_YOU_SURE = AppLocalizations.getString("Are you sure?");
  ...
  // Buttons
  static final String FIND_MENTOR_NETWORK = AppLocalizations.getString("Find Mentor Network");
  ...
  static final String HOW_IT_WORKS = AppLocalizations.getString("How It Works?");
  static final String CONTACT_DETAILS = AppLocalizations.getString("Contact Details");
  ...
  static final String CREATE_ACCOUNT = AppLocalizations.getString("Create account");
  static final String FORGOT_PASSWORD = AppLocalizations.getString("Forgot Password?");
  static final String ALREADY_REGISTERED = AppLocalizations.getString("Already Registered?");
  ...
  static final String APP_DESCRIPTION = "Connecting You From Around The World"; // Change Your Career
  ...
  static final String SEARCH_IN_NETWORK = AppLocalizations.getString("Search in network");
  static final String SEARCH_HISTORY = AppLocalizations.getString("Search History");
  static final String LOCATION_HISTORY = AppLocalizations.getString("Location History");
  static final String SEARCH_MENTOR = AppLocalizations.getString('Search in mentors by name...');
  static final String SEARCH_MENTEE = AppLocalizations.getString('Search in mentees by name...');
  static final String FEEDBACK_LINK_TEXT = AppLocalizations.getString("Feel free to contribute!");
  ...
  static const String GITHUB_LINK = 'https://github.com/findmentor-network/find-mentor';
  static const String LINKEDIN_LINK = 'https://www.linkedin.com/company/find-mentor-network';
  static const String YOUTUBE_LINK = 'https://www.youtube.com/channel/UCx7Q-6Qqrf9TU5gY-i9xovA';
  ...
  static const String API_PERSONS_URL = 'https://findmentor.network/persons.json';
  static const String API_MENTORSHIPS_URL = 'https://findmentor.network/activeMentorships.json';
  static const String ADD_JOB_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSehaOyJDsY_mKOPNYtwrgLv3ynbLUBDsIUFJqyTnNfW16ijPA/viewform';
  static const String ADD_MENTORSHIPS_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSeL6-beT2prYlrD3gyRqZz2ex94CNAe2T9-Ev2I_pd92BOS7g/viewform';
  ...
  static final String SPLASH_TEXT2 = AppLocalizations.getString('Meet, Ask, Listen, Learn');
  static final String SPLASH_TEXT3 = AppLocalizations.getString('Change Your Career');

  // OnBoarding
  static const String ONBOARDING_TITLE_1 = "Find new places and explore adventures";
  ...
  static final String GET_CONNECTED = AppLocalizations.getString("Get Connected");
  static final String SEARCH_JOB = AppLocalizations.getString('Job title, keywords, or company');
  static final String SEARCH_EVENT = AppLocalizations.getString('Search for the event you want to join');
  static final String SUGGESTIONS_DETAILS = 'Every night & every deploy, the spreadsheet will be parsed by GitHub actions, then generate this beauty.\n\n\nIf you have any queries or issues for which you need your assistance: Feel free to mail us.';
