  ...
  Widget _itemTopMenu(String heading) => Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Spacer(),
            Center(
              child: Text(heading, style: TextStyle(fontSize: 14, color: AppConstant.colorHeading, fontWeight: FontWeight.w500)),
            ),
            Spacer(),
            Spacer(),
          ],
            ...
            children: <Widget>[
              ...
              Center(
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text(AppConstant.appDescription, style: TextStyle(fontSize: 14, color: AppConstant.colorDarkGrey)),
                    ],
                  ),
                ),
              ),
            ...
            children: <Widget>[
              Padding(
                ...
                child: MaterialButton(
                  ...
                  child: Text(AppConstant.howItWorksText, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppConstant.colorHeading)),
                  onPressed: () {
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  color: AppConstant.colorDrawerButton,
                  shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(8)),
                  child: Text(AppConstant.contactUsText, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppConstant.colorHeading)),
                  onPressed: () {
        ...
        children: <Widget>[
          Expanded(
            child: PageView(
              ...
              children: <Widget>[
                AppBottomSheetWidgets.buildIletisimItem(_itemTopMenu(AppConstant.contactDetailsText)),
                AppBottomSheetWidgets.buildKatkiItem(_itemTopMenu(AppConstant.feedbackText))
              ],
            ),
          ),
          AppBottomSheetWidgets.selectCategory(
              _horizontalCategoryItem(id: 0, title: AppConstant.contactUsText), _horizontalCategoryItem(id: 1, title: AppConstant.feedbackText))
        ],
      );
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
            height: MediaQuery.of(context).size.height * .5,
            child: Container(
              child: AppBottomSheetWidgets.buildHowItWorksItem(_itemTopMenu(AppConstant.howItWorksText)),
